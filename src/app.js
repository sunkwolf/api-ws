...
var provider_baileys_1 = require("@bot-whatsapp/provider-baileys");
var flowBienvenida = (0, bot_1.addKeyword)('hola').addAnswer('Buenas !! Bienvenido');
        ...
        switch (_a.label) {
            case 0:
                ...
                provider.http.server.post('/send-message', (0, provider_baileys_1.handleCtx)(function (bot, req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    var body, message, mediaUrl, phone;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                body = req.body;
